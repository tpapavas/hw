...
class BdmaCore : public sc_core::sc_module
{
    public:

    SC_HAS_PROCESS(BdmaCore);
    // Constructor
    BdmaCore(sc_core::sc_module_name name);

    sc_core::sc_in<bool> reset_n_;

    // Interrupt
    sc_core::sc_vector< sc_core::sc_out<bool> > interrupt;
    sc_core::sc_out<bool> is_idle;
    sc_core::sc_out<bool> notify_get_config;
...
#if 0
    sc_core::sc_fifo<uint8_t>          *expected_wr_ack;
    sc_core::sc_fifo<uint8_t>          *expected_wr_ack_mc;
    sc_core::sc_fifo<uint8_t>          *expected_wr_ack_cv;
    // fifo used to count the current outstanding cmd which needs wr_complete. The max number is 2.
    sc_core::sc_fifo<uint8_t>          *cmd_req_ack;
#endif

    sc_core::sc_fifo <bdma_ack_info *> *bdma_ack_fifo_;
    
    // Configuration ports
    sc_core::sc_port<sc_core::sc_fifo_in_if<BdmaCoreConfig> > core_config_in;
    sc_core::sc_port<sc_core::sc_fifo_in_if<BdmaCoreInt> > bdma_core_int_fifo;
    ...
    virtual void mcif2bdma_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cvif2bdma_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay);
    ...
    sc_core::sc_event read_credit_granted_;
    //sc_mutex read_credit_mutex_;

    sc_core::sc_event bdma_mc_ack_;
    sc_core::sc_event bdma_cv_ack_;
    ...
    void SendDmaWriteRequest(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay, uint8_t src_ram_type);
...
// mcif
inline void
BdmaCore::mcif2bdma_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
BdmaCore::bdma2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
    uint32_t socket_id;
...
inline void
BdmaCore::bdma2mcif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay)
{
    uint32_t socket_id;
...
// cvif
inline void
BdmaCore::cvif2bdma_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_dma_rd_rsp_t* payload = (nvdla_dma_rd_rsp_t*) bp.get_data_ptr();
...
inline void
BdmaCore::bdma2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
    uint32_t socket_id;
...
inline void
BdmaCore::bdma2cvif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay)
{
    uint32_t socket_id;
