    ...
    public  NV_NVDLA_mcif_base  // ports
{
    public:
        ...
        NV_NVDLA_mcif( sc_core::sc_module_name module_name, bool headless_ntb_env_in, uint8_t nvdla_id_in );
        ~NV_NVDLA_mcif();
...
//extern "C" scsim::cmod::NV_NVDLA_mcif * NV_NVDLA_mcifCon(sc_core::sc_module_name module_name, uint8_t nvdla_id_in);
