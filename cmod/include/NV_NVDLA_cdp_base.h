...
class NV_NVDLA_cdp_base : public sc_core::sc_module
{
    public:

    // Constructor
    NV_NVDLA_cdp_base(const sc_core::sc_module_name name);
    ...
    virtual void csb2cdp_rdma_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2cdp_rdma_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void csb2cdp_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2cdp_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cvif2cdp_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cvif2cdp_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void mcif2cdp_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void mcif2cdp_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;

    // Port has no flow: cvif2cdp_wr_rsp
    sc_core::sc_in<bool> cvif2cdp_wr_rsp;

    // Port has no flow: mcif2cdp_wr_rsp
    sc_core::sc_in<bool> mcif2cdp_wr_rsp;
    ...
    virtual void cdp2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdp_rdma2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdp2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdp2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdp2cvif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdp2mcif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay);
...
inline NV_NVDLA_cdp_base::NV_NVDLA_cdp_base(const sc_core::sc_module_name name)
...
inline void
NV_NVDLA_cdp_base::csb2cdp_rdma_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdp_base::csb2cdp_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload = (NV_MSDEC_csb2xx_16m_secure_be_lvl_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_cdp_base::cvif2cdp_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdp_base::mcif2cdp_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_dma_rd_rsp_t* payload = (nvdla_dma_rd_rsp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_cdp_base::cdp2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdp_base::cdp_rdma2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdp_base::cdp2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdp_base::cdp2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdp_base::cdp2cvif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdp_base::cdp2mcif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay)
{
