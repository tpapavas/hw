...
class NV_NVDLA_csc_base : public sc_core::sc_module
{
    public:

    // Constructor
    NV_NVDLA_csc_base(const sc_core::sc_module_name name);
    ...
    virtual void csb2csc_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2csc_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void accu2sc_credit_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void accu2sc_credit_b_transport(int ID, nvdla_cc_credit_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void dat_up_cdma2sc_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void dat_up_cdma2sc_b_transport(int ID, nvdla_dat_info_update_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void wt_up_cdma2sc_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void wt_up_cdma2sc_b_transport(int ID, nvdla_wt_info_update_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void csc2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void dat_up_sc2cdma_b_transport(nvdla_dat_info_update_t* payload, sc_core::sc_time& delay);
    ...
    virtual void sc2buf_dat_rd_b_transport(nvdla_ram_rd_valid_port_RADDR_12_RDATA_1024_t* payload, sc_core::sc_time& delay);
    ...
    virtual void sc2buf_wt_rd_b_transport(nvdla_ram_rd_valid_port_RADDR_12_RDATA_1024_t* payload, sc_core::sc_time& delay);
    ...
    virtual void sc2buf_wmb_rd_b_transport(nvdla_ram_rd_valid_port_RADDR_8_RDATA_1024_t* payload, sc_core::sc_time& delay);
    ...
    virtual void sc2mac_a_dat_b_transport(nvdla_sc2mac_data_if_t* payload, sc_core::sc_time& delay);
    ...
    virtual void sc2mac_b_dat_b_transport(nvdla_sc2mac_data_if_t* payload, sc_core::sc_time& delay);
    ...
    virtual void sc2mac_a_wt_b_transport(nvdla_sc2mac_weight_if_t* payload, sc_core::sc_time& delay);
    ...
    virtual void sc2mac_b_wt_b_transport(nvdla_sc2mac_weight_if_t* payload, sc_core::sc_time& delay);
    ...
    virtual void wt_up_sc2cdma_b_transport(nvdla_wt_info_update_t* payload, sc_core::sc_time& delay);
...
inline NV_NVDLA_csc_base::NV_NVDLA_csc_base(const sc_core::sc_module_name name)
...
inline void
NV_NVDLA_csc_base::csb2csc_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::accu2sc_credit_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::dat_up_cdma2sc_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::wt_up_cdma2sc_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::csc2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::dat_up_sc2cdma_b_transport(nvdla_dat_info_update_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::sc2buf_dat_rd_b_transport(nvdla_ram_rd_valid_port_RADDR_12_RDATA_1024_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::sc2buf_wt_rd_b_transport(nvdla_ram_rd_valid_port_RADDR_12_RDATA_1024_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::sc2buf_wmb_rd_b_transport(nvdla_ram_rd_valid_port_RADDR_8_RDATA_1024_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::sc2mac_a_dat_b_transport(nvdla_sc2mac_data_if_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::sc2mac_b_dat_b_transport(nvdla_sc2mac_data_if_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::sc2mac_a_wt_b_transport(nvdla_sc2mac_weight_if_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::sc2mac_b_wt_b_transport(nvdla_sc2mac_weight_if_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csc_base::wt_up_sc2cdma_b_transport(nvdla_wt_info_update_t* payload, sc_core::sc_time& delay)
{
