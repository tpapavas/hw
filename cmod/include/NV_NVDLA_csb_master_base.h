...
class NV_NVDLA_csb_master_base : public sc_core::sc_module
{
    public:

    // Constructor
    NV_NVDLA_csb_master_base(const sc_core::sc_module_name name);
    ...
    virtual void glb2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void glb2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void gec2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& gp, sc_core::sc_time& delay);
    virtual void gec2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void mcif2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void mcif2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cvif2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cvif2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void bdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void bdma2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cdma2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void csc2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csc2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cmac_a2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cmac_a2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cmac_b2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cmac_b2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cacc2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cacc2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void sdp_rdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void sdp_rdma2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void sdp2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void sdp2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void pdp_rdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void pdp_rdma2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void pdp2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void pdp2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cdp_rdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cdp_rdma2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cdp2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cdp2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void rbk2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void rbk2csb_resp_b_transport(int ID, nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void csb2glb_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2gec_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2mcif_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2cvif_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2bdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2cdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2csc_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2cmac_a_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2cmac_b_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2cacc_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2sdp_rdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2sdp_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2pdp_rdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2pdp_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2cdp_rdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2cdp_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
    ...
    virtual void csb2rbk_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
...
inline NV_NVDLA_csb_master_base::NV_NVDLA_csb_master_base(const sc_core::sc_module_name name)
...
inline void
NV_NVDLA_csb_master_base::nvdla2csb_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::glb2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::gec2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::mcif2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::cvif2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::bdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::rbk2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::cdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::csc2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::cmac_a2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::cmac_b2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::cacc2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::sdp_rdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::sdp2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::pdp_rdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::pdp2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::cdp_rdma2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::cdp2csb_resp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_xx2csb_resp_t* payload = (nvdla_xx2csb_resp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_csb_master_base::csb2glb_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2gec_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2mcif_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2cvif_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2bdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2rbk_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2cdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2csc_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2cmac_a_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2cmac_b_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2cacc_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2sdp_rdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2sdp_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2pdp_rdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2pdp_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2cdp_rdma_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2cdp_req_b_transport(NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_csb_master_base::csb2nvdla_b_transport(NV_MSDEC_xx2csb_erpt_t* payload, sc_core::sc_time& delay)
{
