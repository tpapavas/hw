...
class NV_NVDLA_rbk_base : public sc_core::sc_module
{
    public:

    // Constructor
    NV_NVDLA_rbk_base(const sc_core::sc_module_name name);
    ...
    virtual void csb2rbk_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2rbk_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cvif2rbk_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cvif2rbk_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void mcif2rbk_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void mcif2rbk_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;

    // Port has no flow: cvif2rbk_wr_rsp
    sc_core::sc_in<bool> cvif2rbk_wr_rsp;

    // Port has no flow: mcif2rbk_wr_rsp
    sc_core::sc_in<bool> mcif2rbk_wr_rsp;
    ...
    virtual void rbk2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void rbk2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void rbk2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void rbk2cvif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void rbk2mcif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay);

    // Port has no flow: rbk2glb_done_intr
    sc_core::sc_vector< sc_core::sc_out<bool> > rbk2glb_done_intr;
...
inline NV_NVDLA_rbk_base::NV_NVDLA_rbk_base(const sc_core::sc_module_name name)
...
inline void
NV_NVDLA_rbk_base::csb2rbk_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_rbk_base::cvif2rbk_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_rbk_base::mcif2rbk_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_dma_rd_rsp_t* payload = (nvdla_dma_rd_rsp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_rbk_base::rbk2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_rbk_base::rbk2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_rbk_base::rbk2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_rbk_base::rbk2cvif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_rbk_base::rbk2mcif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay)
{
