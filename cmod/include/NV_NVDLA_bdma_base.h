...
class NV_NVDLA_bdma_base : public sc_core::sc_module
{
    public:

    // Constructor
    NV_NVDLA_bdma_base(const sc_core::sc_module_name name);
    ...
    virtual void csb2bdma_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2bdma_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cvif2bdma_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cvif2bdma_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void mcif2bdma_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void mcif2bdma_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;

    // Port has no flow: cvif2bdma_wr_rsp
    sc_core::sc_in<bool> cvif2bdma_wr_rsp;

    // Port has no flow: mcif2bdma_wr_rsp
    sc_core::sc_in<bool> mcif2bdma_wr_rsp;
    ...
    virtual void bdma2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void bdma2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void bdma2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void bdma2cvif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void bdma2mcif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay);

    // Port has no flow: bdma2glb_done_intr
    sc_core::sc_vector< sc_core::sc_out<bool> > bdma2glb_done_intr;
...
inline NV_NVDLA_bdma_base::NV_NVDLA_bdma_base(const sc_core::sc_module_name name)
...
inline void
NV_NVDLA_bdma_base::csb2bdma_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_bdma_base::cvif2bdma_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_bdma_base::mcif2bdma_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_dma_rd_rsp_t* payload = (nvdla_dma_rd_rsp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_bdma_base::bdma2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_bdma_base::bdma2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_bdma_base::bdma2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_bdma_base::bdma2cvif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_bdma_base::bdma2mcif_wr_req_b_transport(nvdla_dma_wr_req_t* payload, sc_core::sc_time& delay)
{
