...
class NV_NVDLA_cmac_base : public sc_core::sc_module
{
    public:

    // Constructor
    NV_NVDLA_cmac_base(const sc_core::sc_module_name name);
    ...
    virtual void csb2cmac_a_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2cmac_a_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void sc2mac_dat_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void sc2mac_dat_b_transport(int ID, nvdla_sc2mac_data_if_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void sc2mac_wt_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void sc2mac_wt_b_transport(int ID, nvdla_sc2mac_weight_if_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cmac_a2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void mac2accu_b_transport(nvdla_mac2accu_data_if_t* payload, sc_core::sc_time& delay);
...
inline NV_NVDLA_cmac_base::NV_NVDLA_cmac_base(const sc_core::sc_module_name name)
...
inline void
NV_NVDLA_cmac_base::csb2cmac_a_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cmac_base::sc2mac_dat_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cmac_base::sc2mac_wt_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cmac_base::cmac_a2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cmac_base::mac2accu_b_transport(nvdla_mac2accu_data_if_t* payload, sc_core::sc_time& delay)
{
