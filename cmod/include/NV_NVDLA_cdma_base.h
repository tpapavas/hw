...
class NV_NVDLA_cdma_base : public sc_core::sc_module
{
    public:

    // Constructor
    NV_NVDLA_cdma_base(const sc_core::sc_module_name name);
    ...
    virtual void csb2cdma_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2cdma_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void dat_up_sc2cdma_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void dat_up_sc2cdma_b_transport(int ID, nvdla_dat_info_update_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void mcif2cdma_dat_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void mcif2cdma_dat_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cvif2cdma_dat_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cvif2cdma_dat_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cvif2cdma_wt_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cvif2cdma_wt_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void mcif2cdma_wt_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void mcif2cdma_wt_rd_rsp_b_transport(int ID, nvdla_dma_rd_rsp_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void wt_up_sc2cdma_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void wt_up_sc2cdma_b_transport(int ID, nvdla_wt_info_update_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void cdma_wt_dma_arbiter_source_id_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void cdma_wt_dma_arbiter_source_id_b_transport(int ID, int source_id, sc_core::sc_time& delay) = 0;
    ...
    virtual void cdma2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void dat_up_cdma2sc_b_transport(nvdla_dat_info_update_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdma_dat2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdma_dat2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdma_wt2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdma_wt2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdma2buf_dat_wr_b_transport(nvdla_ram_wr_port_WADDR_12_WDATA_512_BE_1_t* payload, sc_core::sc_time& delay);
    ...
    virtual void cdma2buf_wt_wr_b_transport(nvdla_ram_wr_port_WADDR_12_WDATA_512_BE_1_t* payload, sc_core::sc_time& delay);
    ...
    virtual void wt_up_cdma2sc_b_transport(nvdla_wt_info_update_t* payload, sc_core::sc_time& delay);

    // Port has no flow: cdma_dat2glb_done_intr
    sc_core::sc_vector< sc_core::sc_out<bool> > cdma_dat2glb_done_intr;

    // Port has no flow: cdma_wt2glb_done_intr
    sc_core::sc_vector< sc_core::sc_out<bool> > cdma_wt2glb_done_intr;

    sc_core::sc_in <bool> cdma_wt_dma_arbiter_override_enable;
    // Destructor
...
inline NV_NVDLA_cdma_base::NV_NVDLA_cdma_base(const sc_core::sc_module_name name)
...
inline void
NV_NVDLA_cdma_base::csb2cdma_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::dat_up_sc2cdma_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::mcif2cdma_dat_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::cvif2cdma_dat_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_dma_rd_rsp_t* payload = (nvdla_dma_rd_rsp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_cdma_base::cvif2cdma_wt_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_dma_rd_rsp_t* payload = (nvdla_dma_rd_rsp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_cdma_base::mcif2cdma_wt_rd_rsp_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    nvdla_dma_rd_rsp_t* payload = (nvdla_dma_rd_rsp_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_cdma_base::wt_up_sc2cdma_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::cdma_wt_dma_arbiter_source_id_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    int source_id;
...
inline void
NV_NVDLA_cdma_base::cdma2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::dat_up_cdma2sc_b_transport(nvdla_dat_info_update_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::cdma_dat2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::cdma_dat2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::cdma_wt2cvif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::cdma_wt2mcif_rd_req_b_transport(nvdla_dma_rd_req_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::cdma2buf_dat_wr_b_transport(nvdla_ram_wr_port_WADDR_12_WDATA_512_BE_1_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::cdma2buf_wt_wr_b_transport(nvdla_ram_wr_port_WADDR_12_WDATA_512_BE_1_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_cdma_base::wt_up_cdma2sc_b_transport(nvdla_wt_info_update_t* payload, sc_core::sc_time& delay)
{
