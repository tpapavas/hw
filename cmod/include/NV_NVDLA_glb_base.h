...
class NV_NVDLA_glb_base : public sc_core::sc_module
{
    public:

    // Constructor
    NV_NVDLA_glb_base(const sc_core::sc_module_name name);
    ...
    virtual void csb2glb_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2glb_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;
    ...
    virtual void csb2gec_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay);
    virtual void csb2gec_req_b_transport(int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay) = 0;

    // Port has no flow: sdp2glb_done_intr
    sc_core::sc_vector< sc_core::sc_in<bool> > sdp2glb_done_intr;

    // Port has no flow: cdp2glb_done_intr
    sc_core::sc_vector< sc_core::sc_in<bool> > cdp2glb_done_intr;

    // Port has no flow: pdp2glb_done_intr
    sc_core::sc_vector< sc_core::sc_in<bool> > pdp2glb_done_intr;

    // Port has no flow: bdma2glb_done_intr
    sc_core::sc_vector< sc_core::sc_in<bool> > bdma2glb_done_intr;

    // Port has no flow: bdma2glb_done_intr
    sc_core::sc_vector< sc_core::sc_in<bool> > rbk2glb_done_intr;

    // Port has no flow: cdma_dat2glb_done_intr
    sc_core::sc_vector< sc_core::sc_in<bool> > cdma_dat2glb_done_intr;

    // Port has no flow: cdma_wt2glb_done_intr
    sc_core::sc_vector< sc_core::sc_in<bool> > cdma_wt2glb_done_intr;

    // Port has no flow: cacc2glb_done_intr
    sc_core::sc_vector< sc_core::sc_in<bool> > cacc2glb_done_intr;
    ...
    virtual void glb2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
    ...
    virtual void gec2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay);
...
inline NV_NVDLA_glb_base::NV_NVDLA_glb_base(const sc_core::sc_module_name name)
...
inline void
NV_NVDLA_glb_base::csb2glb_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_glb_base::csb2gec_req_b_transport(int ID, tlm::tlm_generic_payload& bp, sc_core::sc_time& delay)
{
    NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload = (NV_MSDEC_csb2xx_16m_secure_be_lvl_t*) bp.get_data_ptr();
...
inline void
NV_NVDLA_glb_base::glb2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
...
inline void
NV_NVDLA_glb_base::gec2csb_resp_b_transport(nvdla_xx2csb_resp_t* payload, sc_core::sc_time& delay)
{
