...
void NV_NVDLA_cdp::CdpConsumerThread () {
    while (true) {
        ...
        cslDebug((70,"[CDP][G1 START] time=%s nvdla_cycles=%llu\n",sc_time_stamp().to_string().c_str(), (uint64_t)(sc_time_stamp() / gNvdlaStats.nvdlaClockPeriod)));
...
void NV_NVDLA_cdp::CdpIntrThread() {
    while (true) {
        ...
        if(ack->group_id == 0){
            ...
            cslDebug((70,"[CDP][G0 END] time=%s nvdla_cycles=%llu\n", sc_time_stamp().to_string().c_str(),(uint64_t)(sc_time_stamp() / gNvdlaStats.nvdlaClockPeriod)));
            ...
            cslDebug((70,"[CDP][G1 END] time=%s nvdla_cycles=%llu\n", sc_time_stamp().to_string().c_str(),(uint64_t)(sc_time_stamp() / gNvdlaStats.nvdlaClockPeriod)));
        }
