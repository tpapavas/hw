...
class cdp_reg_model {
    ...
    protected:
        ...
        sc_core::sc_event event_cdp_reg_group_0_operation_enable;
        sc_core::sc_event event_cdp_reg_group_1_operation_enable;
        ...
        // void csb2cdp_b_transport (int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
