...
class pdp_rdma_reg_model {
    ...
    protected:
        ...
        sc_core::sc_event event_pdp_rdma_reg_group_0_operation_enable;
        sc_core::sc_event event_pdp_rdma_reg_group_1_operation_enable;
        ...
        // void csb2pdp_rdma_b_transport (int ID, NV_MSDEC_csb2xx_16m_secure_be_lvl_t* payload, sc_core::sc_time& delay);
